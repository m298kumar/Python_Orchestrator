...
_DEFAULT_DOMAIN_KEYWORDS: Dict[str, List[str]] = {
    "financial services": [
        "cheque", "banking", "deposit", "rcd", "micr", "clearing",
        "transaction", "account", "ledger", "transfer", "payment",
    ],
    "healthcare": [
        "patient", "clinical", "ehr", "prescription", "pharmacy",
        "diagnosis", "medical", "health", "hospital", "appointment",
    ],
    "retail e-commerce": [
        "product", "cart", "checkout", "inventory", "catalogue",
        "order", "shipping", "storefront", "wishlist", "coupon",
    ],
    "insurance": [
        "policy", "claim", "premium", "underwriting", "insur",
        "coverage", "deductible", "adjuster", "beneficiary",
    ],
    "education": [
        "student", "course", "enrol", "grade", "curriculum",
        "lms", "assignment", "syllabus", "semester", "faculty",
    ],
    "IT service management": [
        "ticket", "incident", "asset", "sla", "helpdesk",
        "itil", "change request", "service desk", "escalation",
    ],
}
